...
import com.gvvghost.movieapp.data.Your;
...
public class MovieDetailViewModel extends AndroidViewModel {
    ...
    public void loadVideos(int id) {
        Disposable disposable = ApiFactory.apiService.loadMovieDetails(id, Your.API_KEY)
    ...
    public void loadReviews(int id) {
        Disposable disposable = ApiFactory.apiService.loadMovieReviews(id, Your.API_KEY)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
